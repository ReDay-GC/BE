...
public class SearchMemoryByEmotionUseCase {
    ...
    public List<MemoryListResponse> execute(Long userId, String emotion) {
        return memoryRepository.findAllByUserIdAndEmotionOrderByMemoryDateDesc(userId, emotion)
                .stream()
